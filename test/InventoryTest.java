...
class InventoryTest {
    ...
    @Test
    void testCheckSpace() {
        Item tezkyPredmet = new Item("Zlaté cihly", "zlato", "sjsivsuib", 3, true,true,3, 3,"predsin" ,false  );
    ...
    void testHasItem() {
        ...
        Item nuz = new Item("OstrýNůž", "nuz", "hahaha", 5, true, false, 2, 2, "loznice" ,true );
